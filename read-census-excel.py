##! python3
# read-census-excel.py - Tabulates population and number of census tracts for each county.
...
# Open and read the cells of an Excel document with the openpyxlmodule
